...
var destinationIp = Argument("destinationPi", "192.168.0.199");
var destinationDirectory = Argument("destinationDirectory", @"/home/pi/work/RubikCubeSolver");
var username = Argument("username", "pi");
var sessionname = Argument("sessionname", "RapsberryPI");
var executableName = Argument("executableName", "rubikcubesolver");
